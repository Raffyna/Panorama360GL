...
public class SphericalView extends RelativeLayout {
    ...
    public void setPanorama(Bitmap bitmap, boolean keepCameraAngle, Bitmap icon) {
...
//        PLSpherical2Panorama panoramaICon = new PLSpherical2Panorama();
//        panoramaICon.setImage(new PLImage(icon, true));
//        float pitch1 = 0.19356553554879063f;
//        float yaw2= -2.14077619383343f;
...
//        plManager.setPanorama(panoramaICon);
//        init = true;
